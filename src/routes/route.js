...
// Books API
router.post("/books", auth.authentication, valid.validBook, booksController.createBook);//vinit
...
router.delete("/books/:bookId", auth.authentication, booksController.deleteBooks);//vinit
